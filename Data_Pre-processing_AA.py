...
df.dropna(subset=['fuel_type'], inplace=True) #cleaning fuel_type col
...
df.dropna(subset=['transmission'], inplace=True) #cleaning fuel_type col
...
df.drop(index_btype, inplace = True)  #cleaning body_type col
...
df['make'].replace('MG MOTOR UK', 'MG', inplace=True)  #cleaning make col
...
df.dropna(subset=['engine_size'], inplace=True) #cleaning engine_size col
...
df.dropna(subset=['year'], inplace=True) #cleaning year col
...
df['mileage'].astype(int) #cleaning mileage col
