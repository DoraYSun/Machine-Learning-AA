...
class LassoRegressionModel():
    ...
    def __init__(self):
        ...
        self._evaluate_lasso_regression_model()


    def _lasso_regression_hyperparameters_tuning(self):
        """tuning hyperparameters of lasso regression model for best performance"""
    ...
    def _evaluate_lasso_regression_model(self):
        """fit training data into lasso regression model and reflect how well lasso regression model performs on validation set"""
        self._lasso_regression_hyperparameters_tuning()
        l1_best = Lasso(alpha=self.best_params['alpha'], normalize=self.best_params['normalize']) # use best hyperparameters from tuning
