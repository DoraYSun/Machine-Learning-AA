...
class RidgeRegressionModel():
    ...
    def evaluate_ridge_regression_model(self):
        """fit training data into ridge regression model and reflect how well lasso regression model performs on validation set"""
        self._ridge_regression_hyperparameters_turning()
        l2_best = Ridge(alpha=self.best_params['alpha'], normalize=self.best_params['normalize'])
...
# %%
model_12 = RidgeRegressionModel()
# model_1.fit_linear_regression_model()
model_12.evaluate_ridge_regression_model()
# %%
